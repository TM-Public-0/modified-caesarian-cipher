...
const FloatingDockDesktop = ({
  ...
  return (
    (<motion.div
      ...
      className={cn(
        "mx-auto hidden md:flex gap-4 items-end  rounded-2xl bg-transparent dark:bg-neutral-900 px-4 pb-3",
        className
      )}>
      {items.map((item) => (
...
export default function ContactButtons(){
    const links = [
        ...
        //     ),
        //     href: "https://tomasmaldonado.rf.gd/",
        // },
      ];

    return (
    <div className="flex flex-col items-center justify-center h-24 z-12">
        <FloatingDock
